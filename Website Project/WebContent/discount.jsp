...
<%
	...
	Cookie c = new Cookie("myCookie", s + "_c");
	c.setMaxAge(60);
...
<body
	...
	<p align="right">
		<b class="reg">>><a href="" style="color:white;background-color:black;">Logged as <%out.println(c.getValue());%></a></b>
			
	</p>
		<p align="right">
		<b>><a href="dbShow.jsp">List of users</a></b>
	</p>
	...
	<div class="navbar">
		...
		<a href="details.html"><i class="fa fa-file"
			...
			style="color: white; padding: 2px;"></i>Add Item</a> <a
			href="discount.jsp">% Discount</a>
		<div class="dropdown">
			<button class="dropbtn">Social Media</button>
			<div class="dropdown-content">
				<a href="https://www.youtube.com/melihkurtaran"
					class="fa fa-youtube"></a> <a
					href="https://www.facebook.com/melih.kurtaran"
					class="fa fa-facebook"></a> <a
					href="https://www.instagram.com/melihkurtaran/?hl=en"
					class="fa fa-instagram"></a> <a
					href="https://www.linkedin.com/in/melihkurtaran/"
					class="fa fa-linkedin"></a> <a href="https://twitter.com/melih972"
	...
	<h1 style="color:white;text-align:center;margin-bottom:200px;"><a href="items.xml">Click to see discounted items!</a></h1>
